...
<i class="las la-superscript la-lg"></i> Python

<i class="las la-project-diagram la-lg"></i> R

<i class="lab la-connectdevelop la-lg"></i> SQL

<i class="las la-chart-line la-lg"></i> Javascript

<i class="las la-microscope la-lg"></i> Matlab
...
<i class="las la-superscript la-lg"></i> Tableau

<i class="las la-project-diagram la-lg"></i> HTML/CSS

<i class="lab la-connectdevelop la-lg"></i> Looker Studio

<i class="las la-chart-line la-lg"></i> AWS

<i class="las la-microscope la-lg"></i> Adobe
