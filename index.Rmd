...
![logo](assets/figures/icon.jpeg){width=60%}
...
- <i class="fa fa-github la-lg"></i>  github.com/hluebbering
- <i class="fa fa-link la-lg"></i> hannah-luebbering.com
- <i class="fab fa-linkedin-in la-lg"></i> linkedin.com/in/hannah-luebbering
...
<i class="las la-pen la-lg"></i> `Technical Writing`

<i class="las la-project-diagram la-lg"></i> `Research and Technology`

<i class="las la-atom la-lg"></i> `Analytical Chemistry`


<i class="las la-microscope la-lg"></i> `Spectroscopy tools in nanotechnology`

<i class="las la-sun la-lg"></i> `Solar Energy`

<i class="lab la-connectdevelop la-lg"></i> `Data Science`

<i class="las la-chart-line la-lg"></i> `Statistical Analysis`

<i class="las la-superscript la-lg"></i> `Mathematical Modeling`

<i class="las la-laptop-code la-lg"></i> `Mathematical Programming`

<i class="lab la-html5 la-lg"></i> `HTML`
...
Academic Projects {data-icon="las la-book"}
--------------------------------------------------------------------------------
...
<!-- ![](assets/figures/svg/flow.svg){width=50%} -->
...
Affiliations {data-icon="las la-users"}
--------------------------------------------------------------------------------
